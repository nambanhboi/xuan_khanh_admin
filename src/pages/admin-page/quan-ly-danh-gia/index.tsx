...
import { Col, Divider, Form, Row, Modal, Button, message, Switch, Space } from 'antd';
        ...
        <TableCustom
            ...
            param_export={{
                "Columns": [
                  ...
                  { "DisplayName": "Đánh giá chất lượng", "PropertyName": "danh_gia_chat_luong" },
                  { "DisplayName": "Nội dung đánh giá", "PropertyName": "noi_dung_danh_gia" },
                  { "DisplayName": "Nội dung phản hồi", "PropertyName": "noi_dung_phan_hoi" },
                  { "DisplayName": "Ngày đánh giá", "PropertyName": "ngay_danh_gia", "Format": "dd/MM/yyyy HH:mm:ss" }
                ],
            ...
            searchComponent={
              <>
              <Form.Item name="ma_san_pham" style={{ marginBottom: '16px' }}>
                <FormSelect
                  label="Mức đánh giá"
              ...
              <Form.Item name="muc_danh_gia" style={{ marginBottom: '16px' }}>
                <FormSelect
                  label="Mức đánh giá"
                  selectType='normal'
        ...
        <Modal
          ...
          footer={            
            <Space className="modal-footer-custom">
              ...
              />
              <ButtonCustom text="Phản hồi" variant="solid" onClick={() => handleRep()} />
            </Space>
          }
        >
